...
/**
 * 
 * Created by daoxing on 2016/9/29.
 */
public class JsonType implements UserType, Serializable {
    ...
    @Override
    public void nullSafeSet(PreparedStatement preparedStatement, Object value, int i, SessionImplementor session) throws HibernateException, SQLException {
        if(value == null) {
            preparedStatement.setNull(i, Types.VARCHAR);
        } else {
            preparedStatement.setString(i, JsonUtils.toString(value));
        }
    }
    ...
    public Object deepCopy(Object o) throws HibernateException {
        ...
        HashMap jsonList = new HashMap(10);
        jsonList.putAll((Map)o);
        return jsonList;
    }
