...
import com.bbbbb.pay.common.dao.BindOrderDao;
import com.bbbbb.pay.common.dao.BindRecordDao;
import com.bbbbb.pay.common.dao.ChannelConfigDao;
import com.bbbbb.pay.common.dao.OpenUserDao;
...
import com.bbbbb.pay.common.entity.BindRecord;
...
public class PayServiceImpl implements PayService {
    ...
    public PaySubmitResult yeepayFirstPay(FastPay pay, FirstPayForm form, ChannelConfig config) {
    	...
    	PaySubmitResult payResult = new PaySubmitResult();
    	com.bbbbb.pay.common.pay.form.FirstPayForm commonForm = parseFirstPayForm(form);
...
//    	payResult.setCode(result.getErrCode());
    ...
    public com.bbbbb.pay.common.pay.form.FirstPayForm parseFirstPayForm(FirstPayForm form) {
    	com.bbbbb.pay.common.pay.form.FirstPayForm commonForm = new  com.bbbbb.pay.common.pay.form.FirstPayForm();
